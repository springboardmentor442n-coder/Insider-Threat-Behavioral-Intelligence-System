        ...
        <div className="result-card">
            ...
            <div className="result-content-structured">
                ...
                <div className="result-message-box">
                    {isThreat 
                        ? "Warning: Anomalous behavioral patterns detected. The model indicates a high risk of insider threat activity. Immediate review of this user's activities is recommended."
