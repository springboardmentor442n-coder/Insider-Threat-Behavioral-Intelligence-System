        ...
        return (
            <div className="result-card">
                <div className="result-empty">
                    ...
                    <p>Submit the form to see the intelligence analysis.</p>
                </div>
            </div>
        );
    }

    const isThreat = result === "INSIDER" || result === "Threat";
        ...
        <div className="result-card">
            <div className="result-content">
                ...
                <div className="result-message">
                    {isThreat 
                        ? "Warning: The provided metrics strongly correlate with known insider threat profiles. Immediate review of this user's activities is recommended."
                        : "The provided metrics fall within standard operational baselines. No anomalous or malicious behavioral patterns detected."
                    }
                </div>
            </div>
        </div>
